...
<p align="center">
  <!-- 如果有项目图片，可以在这里居中放置 -->
  <img src="5a94996a-4337-4e8a-90df-cbf9a0adbb19.jpg" width="80%" />
</p>
...
```mermaid
graph TD
    %% 节点样式定义（让图表呈现高级的学术灰蓝调）
    classDef data fill:#f4f5f7,stroke:#9aa0a6,stroke-width:1px,color:#3c4043;
    classDef model fill:#e8f0fe,stroke:#1a73e8,stroke-width:1.5px,color:#1557b1;
    classDef ui fill:#e6f4ea,stroke:#137333,stroke-width:1.5px,color:#137333;
    classDef side fill:#fff,stroke:#dadce0,stroke-dasharray: 5 5,color:#5f6368;

    %% 核心节点与连接
    A["[城市空间大数据 (GIS/POI/Weibo)]"] --> B["[AI / 机器学习预测模型]"]
    B --> C["[前端 HCI 移动交互界面]"]
